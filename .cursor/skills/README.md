# CrabDeck Quantum skills

Cursor skills distilled from the Shell Cracked / bHive / event-loop sprint.
Read the matching `SKILL.md` before changing that subsystem.

| Skill | Use when |
| ----- | -------- |
| [crabdeck-stack](crabdeck-stack/SKILL.md) | Orienting on ports, processes, security defaults |
| [crabdeck-event-loop](crabdeck-event-loop/SKILL.md) | Adding agent I/O, heartbeats, or Ollama/task work |
...
Always-on rules live in [`.cursor/rules`](../rules/).
